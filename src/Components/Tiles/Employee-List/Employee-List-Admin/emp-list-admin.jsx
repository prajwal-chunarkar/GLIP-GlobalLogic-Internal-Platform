...
function EmpListAdmin() {
  ...
  function viewDetails(id) {
    axios(`http://localhost:3003/users/${id}`)
      .then((res) => {
  ...
  function ChangeDesignation(id) {
    ...
    const upObj = {
      ...
      mname: currUser.mname,
      lname: currUser.lname,
      email: currUser.email,
      phone: currUser.phone,
      workLocation: currUser.workLocation,
      ...
      user_type: currUser.user_type
    };

    if (selectOption !== currUser.designation) {
      axios.put(`http://localhost:3003/users/${id}`, upObj)
        .then(() => {
                    ...
                    return (
                      <TableRow hover role="checkbox" tabIndex={-1} key={index}>
                        ...
                        <TableCell align="center">
                          ...
                          <Button onClick={() => deleteUser(emp.id)}>
                ...
                <Table
                  ...
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>{currUser?.id}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell style={{ fontWeight: 'bold' }}>
                        Employee Name
